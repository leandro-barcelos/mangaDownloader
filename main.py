...
class Chapter:
    def __init__(self, chapterNumber):
        ...
        self.URL = f"https://cdn.readdetectiveconan.com/file/mangap/2/{chapterID}/"
        self.getPages()
    ...
    def getPages(self):
        ...
        for i in range(1,100):
            response = requests.get(self.URL + f"{i}.jpeg")
...
def saveChapterToFolder(chapter):
    ...
    chapterFolder = f"Chapters/chapter{chapter.number}"
    try:
